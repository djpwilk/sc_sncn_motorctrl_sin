...
--------------------------------
   ...
   #. Search for *SOMANET Digital IO Demo*.
   ...
   #. The application will be called *app_test_gpio_digital* in the *Project Explorer* window.

Building the Webserver demo application:

   #. Click on the *app_test_gpio_digital* item in the *Project Explorer* window.
...
To run the application using xTIMEcomposer studio:
   ...
   #. In the *Project Explorer* window, locate the *app_test_gpio_digital.xe* in the ``/bin`` directory
